...
module.exports = (
  ...
  <span
    ...
    }; max-width: ${presentationWidth}px; margin-left: auto; margin-right: auto; flex: ${
      responsiveSizesResult.aspectRatio
    }"
  >
    <span
  ...
  ${rawHTML}
    ...
    if (options.showCaptions && node.title) {
      rawHTML = `
  <figure class="gatsby-resp-image-figure" style="flex:${
    responsiveSizesResult.aspectRatio
  }">
  ${rawHTML}
